...
@Getter
@Setter
@Table(name = "GREASE_CHEMICAL_SALT_STOCK")
@Entity
public class GreaseChemicalSalt implements Serializable, Auditable {
    ...
    @Column(name = "STOCK_1009")
    private Double stock1009;

    @Column(name = "RECEIVED_1009")
    private Double received1009;

    @Column(name = "USED_1009")
    private Double used1009;

    @Column(name = "STOCK_2008")
    private Double stock2008;

    @Column(name = "RECEIVED_2008")
    private Double received2008;

    @Column(name = "USED_2008")
